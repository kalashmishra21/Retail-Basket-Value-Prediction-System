            ...
            <div className="grid grid-cols-3 gap-8">
              ...
              <div className="col-span-2">
                ...
                <div className="flex items-baseline space-x-2 mb-4">
                  <span className={`text-6xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>$112.45</span>
                  <span className={`text-2xl ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>USD</span>
                </div>
                <div className="flex items-center space-x-4 mb-6">
                  <div className="flex items-center space-x-2">
                    <span className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>94.2% Confidence</span>
                  </div>
                  <div className="flex items-center space-x-2">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className={`text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>#RBV-2024-9912</p>
                </div>
                <div>
                  <p className={`text-xs ${isDarkMode ? 'text-gray-500' : 'text-gray-500'} mb-1`}>PROCESSED AT</p>
                  <p className={`text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>📅 Oct 24, 14:22Z</p>
                </div>
                <div>
                  <p className={`text-xs ${isDarkMode ? 'text-gray-500' : 'text-gray-500'} mb-1`}>INPUTS DETECTED</p>
                  <p className={`text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>42 Data Points</p>
                </div>
                <div>
                  <p className={`text-xs ${isDarkMode ? 'text-gray-500' : 'text-gray-500'} mb-1`}>MARGIN OF ERROR</p>
                  <p className={`text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>+/- $3.12</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Historical Monthly Spend</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Electronics Category</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Weekend Shopping Factor</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Peak Hour Traffic</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Items in Cart Count</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Distance from Store</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Historical Avg</span>
                    <span className={`text-sm font-bold ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Base</span>
                  </div>
                  <div className={`w-full ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'} rounded-full h-2`}>
                    <div className="bg-gray-400 h-2 rounded-full" style={{ width: '100%' }}></div>
                  </div>
                  <p className={`text-xs ${isDarkMode ? 'text-gray-500' : 'text-gray-500'} mt-1`}>+$45.00</p>
                </div>
              </div>
